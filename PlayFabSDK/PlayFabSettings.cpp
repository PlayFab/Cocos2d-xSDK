...
namespace PlayFab
{
    ...
    const std::string PlayFabSettings::sdkVersion = "0.71.190916";
    const std::string PlayFabSettings::buildIdentifier = "jbuild_cocos2d-xsdk__sdk-genericslave-1_0";
    const std::string PlayFabSettings::versionString = "Cocos2d-xSDK-0.71.190916";
