...
namespace PlayFab
{
    ...
    const std::string PlayFabSettings::sdkVersion = "0.51.181001";
    const std::string PlayFabSettings::buildIdentifier = "jbuild_cocos2d-xsdk__sdk-slave2016-3_0";
    const std::string PlayFabSettings::versionString = "Cocos2d-xSDK-0.51.181001";
