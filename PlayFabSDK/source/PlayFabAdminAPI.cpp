...
void PlayFabAdminAPI::OnCreatePlayerStatisticDefinitionResult(int httpStatus, HttpRequest* request, void* userData)
{
    ...
    if (PlayFabRequestHandler::DecodeRequest(httpStatus, request, userData, outResult, errorResult))
    {
        ...
        if (request->GetResultCallback() != nullptr)
        {
            CreatePlayerStatisticDefinitionCallback successCallback = static_cast<CreatePlayerStatisticDefinitionCallback>(request->GetResultCallback());
            successCallback(outResult, request->GetUserData());
        }
    }
    else
...
void PlayFabAdminAPI::OnGetPlayerStatisticDefinitionsResult(int httpStatus, HttpRequest* request, void* userData)
{
    ...
    if (PlayFabRequestHandler::DecodeRequest(httpStatus, request, userData, outResult, errorResult))
    {
        ...
        if (request->GetResultCallback() != nullptr)
        {
            GetPlayerStatisticDefinitionsCallback successCallback = static_cast<GetPlayerStatisticDefinitionsCallback>(request->GetResultCallback());
            successCallback(outResult, request->GetUserData());
        }
    }
    else
...
void PlayFabAdminAPI::OnGetPlayerStatisticVersionsResult(int httpStatus, HttpRequest* request, void* userData)
{
    ...
    if (PlayFabRequestHandler::DecodeRequest(httpStatus, request, userData, outResult, errorResult))
    {
        ...
        if (request->GetResultCallback() != nullptr)
        {
            GetPlayerStatisticVersionsCallback successCallback = static_cast<GetPlayerStatisticVersionsCallback>(request->GetResultCallback());
            successCallback(outResult, request->GetUserData());
        }
    }
    else
...
void PlayFabAdminAPI::OnIncrementPlayerStatisticVersionResult(int httpStatus, HttpRequest* request, void* userData)
{
    ...
    if (PlayFabRequestHandler::DecodeRequest(httpStatus, request, userData, outResult, errorResult))
    {
        ...
        if (request->GetResultCallback() != nullptr)
        {
            IncrementPlayerStatisticVersionCallback successCallback = static_cast<IncrementPlayerStatisticVersionCallback>(request->GetResultCallback());
            successCallback(outResult, request->GetUserData());
        }
    }
    else
...
void PlayFabAdminAPI::RefundPurchase(
    ...
    RefundPurchaseCallback callback,
    ErrorCallback errorCallback,
    void* userData
    )
{
    ...
    mHttpRequester->AddRequest(httpRequest, OnRefundPurchaseResult, nullptr);
}
...
void PlayFabAdminAPI::OnRefundPurchaseResult(int httpStatus, HttpRequest* request, void* userData)
{
    ...
    if (PlayFabRequestHandler::DecodeRequest(httpStatus, request, userData, outResult, errorResult))
    {
        ...
        if (request->GetResultCallback() != nullptr)
        {
            RefundPurchaseCallback successCallback = static_cast<RefundPurchaseCallback>(request->GetResultCallback());
            successCallback(outResult, request->GetUserData());
        }
    }
    else
...
void PlayFabAdminAPI::ResolvePurchaseDispute(
    ...
    ResolvePurchaseDisputeCallback callback,
    ErrorCallback errorCallback,
    void* userData
    )
{
    ...
    mHttpRequester->AddRequest(httpRequest, OnResolvePurchaseDisputeResult, nullptr);
}
...
void PlayFabAdminAPI::OnResolvePurchaseDisputeResult(int httpStatus, HttpRequest* request, void* userData)
{
    ...
    if (PlayFabRequestHandler::DecodeRequest(httpStatus, request, userData, outResult, errorResult))
    {
        ...
        if (request->GetResultCallback() != nullptr)
        {
            ResolvePurchaseDisputeCallback successCallback = static_cast<ResolvePurchaseDisputeCallback>(request->GetResultCallback());
            successCallback(outResult, request->GetUserData());
        }
    }
    else
...
void PlayFabAdminAPI::OnUpdatePlayerStatisticDefinitionResult(int httpStatus, HttpRequest* request, void* userData)
{
    ...
    if (PlayFabRequestHandler::DecodeRequest(httpStatus, request, userData, outResult, errorResult))
    {
        ...
        if (request->GetResultCallback() != nullptr)
        {
            UpdatePlayerStatisticDefinitionCallback successCallback = static_cast<UpdatePlayerStatisticDefinitionCallback>(request->GetResultCallback());
            successCallback(outResult, request->GetUserData());
        }
    }
    else
