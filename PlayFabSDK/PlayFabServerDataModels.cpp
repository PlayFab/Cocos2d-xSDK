...
void PlayFab::ServerModels::writeGenericErrorCodesEnumJSON(GenericErrorCodes enumVal, PFStringJsonWriter& writer)
{
    ...
    case GenericErrorCodesStatisticChildNameInvalid: writer.String("StatisticChildNameInvalid"); break;
    ...
    case GenericErrorCodesStudioDeleted: writer.String("StudioDeleted"); break;
    case GenericErrorCodesStudioDeactivated: writer.String("StudioDeactivated"); break;
    case GenericErrorCodesStudioActivated: writer.String("StudioActivated"); break;
    ...
    case GenericErrorCodesTitleActivationRateLimited: writer.String("TitleActivationRateLimited"); break;
    case GenericErrorCodesTitleActivationInProgress: writer.String("TitleActivationInProgress"); break;
    case GenericErrorCodesTitleDeactivated: writer.String("TitleDeactivated"); break;
    case GenericErrorCodesTitleActivated: writer.String("TitleActivated"); break;
    ...
    case GenericErrorCodesMatchmakingAttributeInvalid: writer.String("MatchmakingAttributeInvalid"); break;
...
GenericErrorCodes PlayFab::ServerModels::readGenericErrorCodesFromValue(const rapidjson::Value& obj)
{
    ...
    if (_GenericErrorCodesMap.size() == 0)
    {
        ...
        _GenericErrorCodesMap["StatisticChildNameInvalid"] = GenericErrorCodesStatisticChildNameInvalid;
        ...
        _GenericErrorCodesMap["StudioDeleted"] = GenericErrorCodesStudioDeleted;
        _GenericErrorCodesMap["StudioDeactivated"] = GenericErrorCodesStudioDeactivated;
        _GenericErrorCodesMap["StudioActivated"] = GenericErrorCodesStudioActivated;
        ...
        _GenericErrorCodesMap["TitleActivationRateLimited"] = GenericErrorCodesTitleActivationRateLimited;
        _GenericErrorCodesMap["TitleActivationInProgress"] = GenericErrorCodesTitleActivationInProgress;
        _GenericErrorCodesMap["TitleDeactivated"] = GenericErrorCodesTitleDeactivated;
        _GenericErrorCodesMap["TitleActivated"] = GenericErrorCodesTitleActivated;
        ...
        _GenericErrorCodesMap["MatchmakingAttributeInvalid"] = GenericErrorCodesMatchmakingAttributeInvalid;
...
void GetStoreItemsServerRequest::writeJSON(PFStringJsonWriter& writer)
{
    writer.StartObject();
    if (CatalogVersion.length() > 0) { writer.String("CatalogVersion"); writer.String(CatalogVersion.c_str()); }
    if (!CustomTags.empty()) {
...
bool GetStoreItemsServerRequest::readFromValue(const rapidjson::Value& obj)
{
    const Value::ConstMemberIterator CatalogVersion_member = obj.FindMember("CatalogVersion");
    if (CatalogVersion_member != obj.MemberEnd() && !CatalogVersion_member->value.IsNull()) CatalogVersion = CatalogVersion_member->value.GetString();
    const Value::ConstMemberIterator CustomTags_member = obj.FindMember("CustomTags");
...
void LoginWithXboxIdRequest::writeJSON(PFStringJsonWriter& writer)
{
    writer.StartObject();
    if (CreateAccount.notNull()) { writer.String("CreateAccount"); writer.Bool(CreateAccount); }
    if (!CustomTags.empty()) {
    ...
    if (InfoRequestParameters != NULL) { writer.String("InfoRequestParameters"); InfoRequestParameters->writeJSON(writer); }
    writer.String("Sandbox"); writer.String(Sandbox.c_str());
    writer.String("XboxId"); writer.String(XboxId.c_str());
    writer.EndObject();
}

bool LoginWithXboxIdRequest::readFromValue(const rapidjson::Value& obj)
{
    const Value::ConstMemberIterator CreateAccount_member = obj.FindMember("CreateAccount");
    if (CreateAccount_member != obj.MemberEnd() && !CreateAccount_member->value.IsNull()) CreateAccount = CreateAccount_member->value.GetBool();
    const Value::ConstMemberIterator CustomTags_member = obj.FindMember("CustomTags");
    ...
    const Value::ConstMemberIterator Sandbox_member = obj.FindMember("Sandbox");
    if (Sandbox_member != obj.MemberEnd() && !Sandbox_member->value.IsNull()) Sandbox = Sandbox_member->value.GetString();
    const Value::ConstMemberIterator XboxId_member = obj.FindMember("XboxId");
    if (XboxId_member != obj.MemberEnd() && !XboxId_member->value.IsNull()) XboxId = XboxId_member->value.GetString();
