...
{
    HttpRequest* httpRequest = new HttpRequest("POST", PlayFabSettings::getURL("/MultiplayerServer/DeleteBuildRegion"));
    httpRequest->SetHeader("Content-Type", "application/json");
    httpRequest->SetHeader("X-PlayFabSDK", PlayFabSettings::versionString);
    httpRequest->SetHeader("X-EntityToken", PlayFabSettings::entityToken);
    ...
    PlayFabSettings::httpRequester->AddRequest(httpRequest, OnDeleteBuildRegionResult, userData);
}

void PlayFabMultiplayerAPI::OnDeleteBuildRegionResult(int httpStatus, HttpRequest* request, void* userData)
{
    EmptyResponse outResult;
    PlayFabError errorResult;
...
{
    HttpRequest* httpRequest = new HttpRequest("POST", PlayFabSettings::getURL("/MultiplayerServer/DeleteContainerImageRepository"));
    httpRequest->SetHeader("Content-Type", "application/json");
    httpRequest->SetHeader("X-PlayFabSDK", PlayFabSettings::versionString);
    httpRequest->SetHeader("X-EntityToken", PlayFabSettings::entityToken);
    ...
    PlayFabSettings::httpRequester->AddRequest(httpRequest, OnDeleteContainerImageRepositoryResult, userData);
}

void PlayFabMultiplayerAPI::OnDeleteContainerImageRepositoryResult(int httpStatus, HttpRequest* request, void* userData)
{
    EmptyResponse outResult;
    PlayFabError errorResult;
...
{
    HttpRequest* httpRequest = new HttpRequest("POST", PlayFabSettings::getURL("/MultiplayerServer/GetMultiplayerSessionLogsBySessionId"));
    httpRequest->SetHeader("Content-Type", "application/json");
    httpRequest->SetHeader("X-PlayFabSDK", PlayFabSettings::versionString);
    httpRequest->SetHeader("X-EntityToken", PlayFabSettings::entityToken);
    ...
    PlayFabSettings::httpRequester->AddRequest(httpRequest, OnGetMultiplayerSessionLogsBySessionIdResult, userData);
}

void PlayFabMultiplayerAPI::OnGetMultiplayerSessionLogsBySessionIdResult(int httpStatus, HttpRequest* request, void* userData)
{
    GetMultiplayerServerLogsResponse outResult;
    PlayFabError errorResult;
...
{
    HttpRequest* httpRequest = new HttpRequest("POST", PlayFabSettings::getURL("/MultiplayerServer/UpdateBuildRegion"));
    httpRequest->SetHeader("Content-Type", "application/json");
    httpRequest->SetHeader("X-PlayFabSDK", PlayFabSettings::versionString);
    httpRequest->SetHeader("X-EntityToken", PlayFabSettings::entityToken);
    ...
    PlayFabSettings::httpRequester->AddRequest(httpRequest, OnUpdateBuildRegionResult, userData);
}

void PlayFabMultiplayerAPI::OnUpdateBuildRegionResult(int httpStatus, HttpRequest* request, void* userData)
{
    EmptyResponse outResult;
    PlayFabError errorResult;
