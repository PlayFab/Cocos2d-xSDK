...
void PlayFab::DataModels::writeEntityTypesEnumJSON(EntityTypes enumVal, PFStringJsonWriter& writer)
{
    switch (enumVal)
    {
...
EntityTypes PlayFab::DataModels::readEntityTypesFromValue(const rapidjson::Value& obj)
{
