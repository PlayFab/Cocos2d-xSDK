...
namespace PlayFab
{
    ...
    public:
        ...
        static void UpdateUserInventoryItemCustomData(ServerModels::UpdateUserInventoryItemDataRequest& request, ProcessApiCallback<ServerModels::UpdateUserInventoryItemDataResult> callback, ErrorCallback errorCallback = nullptr, void* userData = nullptr);
