...
namespace PlayFab
{
    ...
    const std::string PlayFabSettings::sdkVersion = "0.72.191001";
    const std::string PlayFabSettings::buildIdentifier = "jbuild_cocos2d-xsdk__sdk-genericslave-1_2";
    const std::string PlayFabSettings::versionString = "Cocos2d-xSDK-0.72.191001";
