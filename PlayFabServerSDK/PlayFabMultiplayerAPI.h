...
namespace PlayFab
{
    ...
    public:
        ...
        static void CreateBuildWithProcessBasedServer(MultiplayerModels::CreateBuildWithProcessBasedServerRequest& request, ProcessApiCallback<MultiplayerModels::CreateBuildWithProcessBasedServerResponse> callback, ErrorCallback errorCallback = nullptr, void* userData = nullptr);
        ...
        static void EnableMultiplayerServersForTitle(MultiplayerModels::EnableMultiplayerServersForTitleRequest& request, ProcessApiCallback<MultiplayerModels::EnableMultiplayerServersForTitleResponse> callback, ErrorCallback errorCallback = nullptr, void* userData = nullptr);
        ...
        static void GetContainerRegistryCredentials(MultiplayerModels::GetContainerRegistryCredentialsRequest& request, ProcessApiCallback<MultiplayerModels::GetContainerRegistryCredentialsResponse> callback, ErrorCallback errorCallback = nullptr, void* userData = nullptr);
        ...
        static void GetTitleEnabledForMultiplayerServersStatus(MultiplayerModels::GetTitleEnabledForMultiplayerServersStatusRequest& request, ProcessApiCallback<MultiplayerModels::GetTitleEnabledForMultiplayerServersStatusResponse> callback, ErrorCallback errorCallback = nullptr, void* userData = nullptr);
        static void GetTitleMultiplayerServersQuotas(MultiplayerModels::GetTitleMultiplayerServersQuotasRequest& request, ProcessApiCallback<MultiplayerModels::GetTitleMultiplayerServersQuotasResponse> callback, ErrorCallback errorCallback = nullptr, void* userData = nullptr);
        ...
        static void ListBuildAliases(MultiplayerModels::MultiplayerEmptyRequest& request, ProcessApiCallback<MultiplayerModels::ListBuildAliasesForTitleResponse> callback, ErrorCallback errorCallback = nullptr, void* userData = nullptr);
        ...
        static void RolloverContainerRegistryCredentials(MultiplayerModels::RolloverContainerRegistryCredentialsRequest& request, ProcessApiCallback<MultiplayerModels::RolloverContainerRegistryCredentialsResponse> callback, ErrorCallback errorCallback = nullptr, void* userData = nullptr);
    ...
    private:
        ...
        static void OnCreateBuildWithProcessBasedServerResult(int httpStatus, HttpRequest* request, void* userData);
