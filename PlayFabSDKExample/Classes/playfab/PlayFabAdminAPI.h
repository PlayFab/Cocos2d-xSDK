...
namespace PlayFab
{
    ...
    public:
        ...
        typedef void(*RefundPurchaseCallback)(AdminModels::RefundPurchaseResponse& result, void* userData);
        typedef void(*ResetUserStatisticsCallback)(AdminModels::ResetUserStatisticsResult& result, void* userData);
        typedef void(*ResolvePurchaseDisputeCallback)(AdminModels::ResolvePurchaseDisputeResponse& result, void* userData);
        ...
        static void RefundPurchase(AdminModels::RefundPurchaseRequest& request, RefundPurchaseCallback callback, ErrorCallback errorCallback = nullptr, void* userData = nullptr);
        ...
        static void ResolvePurchaseDispute(AdminModels::ResolvePurchaseDisputeRequest& request, ResolvePurchaseDisputeCallback callback, ErrorCallback errorCallback = nullptr, void* userData = nullptr);
