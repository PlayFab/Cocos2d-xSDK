...
namespace PlayFab
{
    ...
    const std::string PlayFabSettings::sdkVersion = "0.85.200615";
    const std::string PlayFabSettings::buildIdentifier = "jbuild_cocos2d-xsdk__sdk-genericslave-3_1";
    const std::string PlayFabSettings::versionString = "Cocos2d-xSDK-0.85.200615";
